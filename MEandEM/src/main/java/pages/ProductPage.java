...
public class ProductPage {
	...
	private WebElement btn_cookie;

	@FindBy(xpath = "//*[@id='react-aria-:R1imteuubaj5taH2:']")
	private WebElement Drpdwn_forSize;
	@FindBy(xpath = "//*[@id='react-aria-:R1imteuubaj5taH1:-option-95068-151432']")
	private WebElement select_Size;
	@FindBy(xpath = "(//*[contains(text(), 'Add to Bag')])[1]")
	private WebElement btn_AddToBag;
	@FindBy(xpath = "(//*[contains(text(),'Review Bag and Checkout')])[1]")
	private WebElement btn_ReviewBagandCheckout;
